...
class loginPage:
    def __init__(self, window):
        ...
        #Login Frame
        self.lgn_frame = Frame(self.window, bg='#040405', width=1166, height=718)
        ...
        #left side image
        self.side_image = Image.open('images\\cmp.png')
        ...
        self.sign_in_image = Image.open('images\sgnup.png')
        ...
        self.lgn_button = Image.open('images\\redbtn.jpg')
        photo = ImageTk.PhotoImage(self.lgn_button)
        self.lgn_button_label = Label(self.lgn_frame, image=photo, bg='#040405')
        self.lgn_button_label.image = photo
        self.lgn_button_label.place(x=550, y=470)
        self.login = Button(self.lgn_button_label, text='REGISTER NOW', font=("yu gothic ui", 13, "bold"), width=25, bd=0,
                            bg='red', cursor='hand2', activebackground='red', fg='white')
