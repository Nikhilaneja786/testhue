...
class lvs():
    ...
    def __init__(self,frame2) -> None:
        ...
        self.tr = Treeview(self.frame2, columns=('name','reason','startdate', 'enddate'), show='headings')
        self.tr.column('# 1',anchor='w',stretch=NO,width=400)
        self.tr.column('# 2',anchor='w',stretch=NO,width=400)
        self.tr.column('# 3',anchor='c',stretch=NO,width=400)
        self.tr.column('# 4',anchor='c',stretch=NO,width=400)
